...
docker run -it --rm --name my-maven-project -v "$(pwd)":/usr/src/mymaven -w /usr/src/mymaven maven:3.8.3-jdk-11 mvn install -Dmaven.test.skip=true

docker run -it --rm -v "$PWD":/usr/src/mymaven -v "$HOME/.m2":/root/.m2 -w /usr/src/mymaven maven:3.8.3-jdk-11 mvn install -Dmaven.test.skip=true 
```
